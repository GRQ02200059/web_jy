...
function(t) {
    ...
    function h(t, e) {
        for (var n, i = 0,
        r = t.length; i < r; ++i) if ((n = t[i]).name === e) return n.value
    }
    function l(t, e, n) {
        for (var i = 0,
        r = t.length; i < r; ++i) if (t[i].name === e) {
            t[i] = c,
    ...
    s.prototype = u.prototype = {
        ...
        on: function(t, e) {
            ...
            if (! (arguments.length < 2)) {
                ...
                for (; ++o < f;) if (n = (t = a[o]).type) r[n] = l(r[n], t.name, e);
    ...
    function N(t, e, n, i, r, a) {
        for (var o, f = 0,
        c = e.length,
        u = a.length; f < u; ++f)(o = e[f]) ? (o.__data__ = a[f], i[f] = o) : n[f] = new k(t, a[f]);
    ...
    function W(t, e, n) {
        ...
        return function(r, a, o) {
            ...
            u = i(e, a, o);
            if (c) for (var s = 0,
            h = c.length; s < h; ++s) if ((f = c[s]).type === t.type && f.name === t.name) return this.removeEventListener(f.type, f.listener, f.capture),
    ...
    function Q(t, e, n) {
        var i = S(t),
        r = i.CustomEvent;
        "function" == typeof r ? r = new r(e, n) : (r = i.document.createEvent("Event"), n ? (r.initEvent(e, n.bubbles, n.cancelable), r.detail = n.detail) : r.initEvent(e, !1, !1)),
        t.dispatchEvent(r)
    }
    var J = [null];
    function K(t, e) {
    ...
    K.prototype = tt.prototype = {
        ...
        select: function(t) {
            ...
            n = e.length,
            i = new Array(n), r = 0; r < n; ++r) for (var a, o, f = e[r], c = f.length, u = i[r] = new Array(c), s = 0; s < c; ++s)(a = f[s]) && (o = t.call(a, a.__data__, s, f)) && ("__data__" in a && (o.__data__ = a.__data__), u[s] = o);
        ...
        selectAll: function(t) {
            ...
            for (var e = this._groups,
            n = e.length,
            i = [], r = [], a = 0; a < n; ++a) for (var o, f = e[a], c = f.length, u = 0; u < c; ++u)(o = f[u]) && (i.push(t.call(o, o.__data__, u, f)), r.push(o));
            return new K(i, r)
        },
        filter: function(t) {
            ...
            for (var e = this._groups,
            n = e.length,
            i = new Array(n), r = 0; r < n; ++r) for (var a, o = e[r], f = o.length, c = i[r] = [], u = 0; u < f; ++u)(a = o[u]) && t.call(a, a.__data__, u, o) && c.push(a);
            return new K(i, this._parents)
        },
        data: function(t, e) {
            if (!t) return _ = new Array(this.size()),
            s = -1,
            ...
            for (var o = a.length,
            f = new Array(o), c = new Array(o), u = new Array(o), s = 0; s < o; ++s) {
                var h = r[s],
                l = a[s],
                d = l.length,
        ...
        merge: function(t) {
            ...
            i = e.length,
            r = n.length,
            a = Math.min(i, r), o = new Array(i), f = 0; f < a; ++f) for (var c, u = e[f], s = n[f], h = u.length, l = o[f] = new Array(h), d = 0; d < h; ++d)(c = u[d] || s[d]) && (l[d] = c);
            for (; f < i; ++f) o[f] = e[f];
        ...
        order: function() {
            ...
            e = -1,
            n = t.length; ++e < n;) for (var i, r = t[e], a = r.length - 1, o = r[a]; --a >= 0;)(i = r[a]) && (o && 4 ^ i.compareDocumentPosition(o) && o.parentNode.insertBefore(i, o), o = i);
            return this
        },
        sort: function(t) {
            function e(e, n) {
        ...
        node: function() {
            for (var t = this._groups,
            e = 0,
            n = t.length; e < n; ++e) for (var i = t[e], r = 0, a = i.length; r < a; ++r) {
                var o = i[r];
                if (o) return o
            }
            return null
        ...
        each: function(t) {
            for (var e = this._groups,
            n = 0,
            i = e.length; n < i; ++n) for (var r, a = e[n], o = 0, f = a.length; o < f; ++o)(r = a[o]) && t.call(r, r.__data__, o, a);
            return this
        },
        attr: function(t, e) {
            var n = b(t);
            ...
            return this.each((null == e ? n.local ?
            function(t) {
                return function() {
        ...
        style: function(t, e, n) {
            return arguments.length > 1 ? this.each((null == e ?
            function(t) {
                return function() {
        ...
        classed: function(t, e) {
            ...
            return this.each(("function" == typeof e ?
            function(t, e) {
                return function() { (e.apply(this, arguments) ? z: D)(this, t)
                }
            }: e ?
            function(t) {
                return function() {
        ...
        text: function(t) {
            return arguments.length ? this.each(null == t ? Y: ("function" == typeof t ?
            function(t) {
                return function() {
        ...
        html: function(t) {
            return arguments.length ? this.each(null == t ? q: ("function" == typeof t ?
            function(t) {
                return function() {
                    var e = t.apply(this, arguments);
        ...
        on: function(t, e, n) {
            ...
            if (f) for (var c, u = 0,
            s = f.length; u < s; ++u) for (i = 0, c = f[u]; i < o; ++i) if ((r = a[i]).type === c.type && r.name === c.name) return c.value
        },
    ...
    ct = function(t, e, n) {
        ...
        for (var i, r = 0,
        a = e ? e.length: 0; r < a; ++r) if ((i = e[r]).identifier === n) return ot(t, i);
        return null
    };
    function ut() {
    ...
    var gt = function() {
        ...
        function x(t, e, n, i, r) {
            var a, f, h, d = n(e, t),
            _ = u.copy();
            if (G(new _t(l, "beforestart", a, t, s, d[0], d[1], 0, 0, _),
            function() {
    ...
    function It(t, e, n, i) {
        ...
        function(t) {
            ...
            f = a - r,
            c = (a + r) / 2;
            return f ? (o = e === a ? (n - i) / f + 6 * (n < i) : n === a ? (i - e) / f + 2 : (e - n) / f + 4, f /= c < .5 ? a + r: 2 - a - r, o *= 60) : f = c > 0 && c < 1 ? 0 : o,
    ...
    function ee(t) {
        ...
        a = fe(t.g),
        o = fe(t.b),
        f = re((.2225045 * r + .7168786 * a + .0606169 * o) / Wt);
        return r === a && a === o ? n = i = f: (n = re((.4360747 * r + .3850649 * a + .1430804 * o) / Zt), i = re((.0139322 * r + .0971045 * a + .7141733 * o) / Gt)),
    ...
    var Ue, Pe, Le, ze, De = function(t, e) {
        var n, i, r, a = Se.lastIndex = Ee.lastIndex = 0,
        o = -1,
        f = [],
        c = [];
        for (t += "", e += ""; (n = Se.exec(t)) && (i = Ee.exec(e));)(r = i.index) > a && (r = e.slice(a, r), f[o] ? f[o] += r: f[++o] = r),
        (n = n[0]) === (i = i[0]) ? f[o] ? f[o] += i: f[++o] = i: (f[++o] = null, c.push({
            i: o,
            x: Ce(n, i)
        })),
        a = Ee.lastIndex;
        return a < e.length && (r = e.slice(a), f[o] ? f[o] += r: f[++o] = r),
        f.length < 2 ? c[0] ?
        function(t) {
            return function(e) {
                return t(e) + ""
    ...
    function je(t, e, n, i) {
        ...
        return function(a, o) {
            ...
            function(t) {
                for (var e, n = -1,
                i = c.length; ++n < i;) f[(e = c[n]).i] = e.x(t);
                return f.join("")
            }
        }
    }
    ...
    var Xe = function(t, e) {
        ...
        n = function(t) {
            ...
            n = function(t) {
                var e, n = t * i,
                f = Ie(b),
                c = o / (2 * d) * (f * (e = He * n + b, ((e = Math.exp(2 * e)) - 1) / (e + 1)) -
                function(t) {
                    return ((t = Math.exp(t)) - 1 / t) / 2
                } (b));
    ...
    function hn() {
        ...
        try { !
            function() {
                fn(),
                ++Qe;
                for (var t, e = We; e;)(t = nn - e._time) >= 0 && e._call.call(null, t),
                e = e._next; --Qe
            } ()
        } finally {
            Qe = 0,
    ...
    function Sn(t, e, n) {
        ...
        return t.each(function() {
            var t = Nn(this, i); (t.value || (t.value = {}))[e] = n.apply(this, arguments)
        }),
        function(t) {
    ...
    zn.prototype = function(t) {
        ...
        select: function(t) {
            ...
            n = this._id;
            "function" != typeof t && (t = g(t));
            for (var i = this._groups,
            r = i.length,
            a = new Array(r), o = 0; o < r; ++o) for (var f, c, u = i[o], s = u.length, h = a[o] = new Array(s), l = 0; l < s; ++l)(f = u[l]) && (c = t.call(f, f.__data__, l, u)) && ("__data__" in f && (c.__data__ = f.__data__), h[l] = c, kn(h[l], e, n, l, h, An(f, n)));
        ...
        selectAll: function(t) {
            ...
            for (var i = this._groups,
            r = i.length,
            a = [], o = [], f = 0; f < r; ++f) for (var c, u = i[f], s = u.length, h = 0; h < s; ++h) if (c = u[h]) {
        ...
        transition: function() {
            ...
            e = this._id,
            n = Dn(), i = this._groups, r = i.length, a = 0; a < r; ++a) for (var o, f = i[a], c = f.length, u = 0; u < c; ++u) if (o = f[u]) {
                var s = An(o, e);
                kn(o, t, n, u, f, {
        ...
        attr: function(t, e) {
            ...
            })(n, i, Sn(this, "attr." + t, e)) : null == e ? (n.local ?
            function(t) {
                return function() {
                    this.removeAttributeNS(t.space, t.local)
                }
        ...
        style: function(t, e, n) {
            ...
            return null == e ? this.styleTween(t,
            function(t, e) {
                var n, i, r;
                return function() {
                    var a = E(this, t),
            ...
            } (t, i)).on("end.style." + t, Pn(t)) : "function" == typeof e ? this.styleTween(t,
            function(t, e, n) {
                var i, r, a;
                return function() {
                    var o = E(this, t),
                    f = n(this),
                    c = f + "";
                    return null == f && (this.style.removeProperty(t), c = f = E(this, t)),
                    o === c ? null: o === i && c === r ? a: (r = c, a = e(i = o, f))
                }
            } (t, i, Sn(this, "style." + t, e))).each(function(t, e) {
                var n, i, r, a, o = "style." + e,
                f = "end." + o;
                return function() {
                    var c = Nn(this, t),
                    u = c.on,
        ...
        remove: function() {
            ...
            function(t, e) {
                ...
                return function() {
                    ...
                    a = r.tween;
                    if (a !== n) for (var o = 0,
                    f = (i = n = a).length; o < f; ++o) if (i[o].name === e) { (i = i.slice()).splice(o, 1);
                        break
                    }
                    r.tween = i
                }
                ...
                return function() {
                    ...
                    if (o !== i) {
                        ...
                        c = 0, u = r.length; c < u; ++c) if (r[c].name === e) {
                            r[c] = f;
                            break
                        }
                        c === u && r.push(f)
        ...
        ease: function(t) {
            ...
            return new Promise(function(a, o) {
                ...
                n.each(function() {
                    var n = Nn(this, i),
                    r = n.on;
                    r !== t && ((e = (t = r).copy())._.cancel.push(f), e._.interrupt.push(f), e._.end.push(c)),
                    n.on = e
                })
            })
        }
    ...
    function jn(t, e) {
        for (var n; ! (n = t.__transition) || !(n = n[e]);) if (! (t = t.parentNode)) return Rn.time = fn(),
        Rn;
        return n
    }
    ...
    et.prototype.transition = function(t) {
        ...
        for (var i = this._groups,
        r = i.length,
        a = 0; a < r; ++a) for (var o, f = i[a], c = f.length, u = 0; u < c; ++u)(o = f[u]) && kn(o, t, e, u, f, n || jn(o, e));
    ...
    Xn.prototype = Vn.prototype = {
        ...
        arcTo: function(t, e, n, i, r) {
            ...
            else if (h > 1e-6) if (Math.abs(s * f - c * u) > 1e-6 && r) {
                var l = n - a,
                d = i - o,
                _ = f * f + c * c,
                p = l * l + d * d,
        ...
        arc: function(t, e, n, i, r, a) {
            ...
            n && (h < 0 && (h = h % Hn + Hn), h > In ? this._ += "A" + n + "," + n + ",0,1," + s + "," + (t - o) + "," + (e - f) + "A" + n + "," + n + ",0,1," + s + "," + (this._x1 = c) + "," + (this._y1 = u) : h > 1e-6 && (this._ += "A" + n + "," + n + ",0," + +(h >= Fn) + "," + s + "," + (this._x1 = t + n * Math.cos(r)) + "," + (this._y1 = e + n * Math.sin(r))))
        },
        ...
        function i(t, e) {
            ...
            function s() {
                ...
                if (t.charCodeAt(r) === ti) {
                    ...
                    return (e = o) >= a ? c = !0 : (i = t.charCodeAt(o++)) === ei ? u = !0 : i === ni && (u = !0, t.charCodeAt(o) === ei && ++o),
    ...
    function _i(t) {
        return function(e, n, i) {
            return 2 === arguments.length && "function" == typeof n && (i = n, n = void 0),
    ...
    var bi = function(t, e) {
        ...
        function i() {
            ...
            o = 0,
            f = 0;
            for (i = 0; i < a; ++i) o += (r = n[i]).x,
            f += r.y;
            for (o = o / a - t, f = f / a - e, i = 0; i < a; ++i)(r = n[i]).x -= o,
            r.y -= f
        }
        return null == t && (t = 0),
        null == e && (e = 0),
    ...
    function gi(t, e, n, i) {
        ...
        var r, a, o, f, c, u, s, h, l, d = t._root,
        _ = {
            data: i
        },
        p = t._x0,
        ...
        y = t._x1,
        v = t._y1;
        if (!d) return t._root = _,
        t;
        for (; d.length;) if ((u = e >= (a = (p + y) / 2)) ? p = a: y = a, (s = n >= (o = (b + v) / 2)) ? b = o: v = o, r = d, !(d = d[h = s << 1 | u])) return r[h] = _,
        t;
        if (f = +t._x.call(null, d.data), c = +t._y.call(null, d.data), e === f && n === c) return _.next = d,
        r ? r[h] = _: t._root = _,
        t;
        do {
    ...
    Ni.copy = function() {
        var t, e, n = new ki(this._x, this._y, this._x0, this._y0, this._x1, this._y1),
        i = this._root;
        if (!i) return n;
        if (!i.length) return n._root = Ti(i),
        n;
        for (t = [{
            source: i,
    ...
    Ni.cover = function(t, e) {
        ...
        a = (i = Math.floor(e)) + 1;
            ...
            for (var o, f, c = r - n,
            u = this._root; n > t || t >= r || i > e || e >= a;) switch (f = (e < i) << 1 | t < n, (o = new Array(4))[f] = u, u = o, c *= 2, f) {
            case 0:
                r = n + c,
                a = i + c;
                break;
    ...
    Ni.find = function(t, e, n) {
        ...
        for (p && _.push(new xi(p, s, h, l, d)), null == n ? n = 1 / 0 : (s = t - n, h = e - n, l = t + n, d = e + n, n *= n); c = _.pop();) if (! (! (p = c.node) || (r = c.x0) > l || (a = c.y0) > d || (o = c.x1) < s || (f = c.y1) < h)) if (p.length) {
            ...
            (u = (e >= y) << 1 | t >= b) && (c = _[_.length - 1], _[_.length - 1] = _[_.length - 1 - u], _[_.length - 1 - u] = c)
        } else {
    ...
    Ni.remove = function(t) {
        ...
        var e, n, i, r, a, o, f, c, u, s, h, l, d = this._root,
        _ = this._x0,
        p = this._y0,
        b = this._x1,
        y = this._y1;
        ...
        if (d.length) for (;;) {
            ...
            if (!d.length) break; (e[h + 1 & 3] || e[h + 2 & 3] || e[h + 3 & 3]) && (n = e, l = h)
        }
        for (; d.data !== t;) if (i = d, !(d = d.next)) return this;
        return (r = d.next) && delete d.next,
        i ? (r ? i.next = r: delete i.next, this) : e ? (r ? e[h] = r: delete e[h], (d = e[0] || e[1] || e[2] || e[3]) && d === (e[3] || e[2] || e[1] || e[0]) && !d.length && (n ? n[l] = d: this._root = d), this) : (this._root = r, this)
    },
    Ni.removeAll = function(t) {
        for (var e = 0,
        n = t.length; e < n; ++e) this.remove(t[e]);
        return this
    },
    Ni.root = function() {
        return this._root
    ...
    Ni.visit = function(t) {
        ...
        for (c && f.push(new xi(c, this._x0, this._y0, this._x1, this._y1)); e = f.pop();) if (!t(c = e.node, i = e.x0, r = e.y0, a = e.x1, o = e.y1) && c.length) {
            var u = (i + a) / 2,
            s = (r + o) / 2; (n = c[3]) && f.push(new xi(n, u, s, a, o)),
    ...
    Ni.visitAfter = function(t) {
        ...
        for (this._root && n.push(new xi(this._root, this._x0, this._y0, this._x1, this._y1)); e = n.pop();) {
            ...
            if (r.length) {
                ...
                u = e.y1,
                s = (o + c) / 2,
                h = (f + u) / 2; (a = r[0]) && n.push(new xi(a, o, f, s, h)),
    ...
    var Si = function(t) {
        ...
        r = 1;
        function a() {
            for (var t, a, f, c, u, s, h, l = e.length,
            d = 0; d < r; ++d) for (a = Mi(e, Ai, Ci).visitAfter(o), t = 0; t < l; ++t) f = e[t],
            s = n[f.index],
            h = s * s,
            c = f.x + f.vx,
            u = f.y + f.vy,
        ...
        function f() {
            if (e) {
                var i, r, a = e.length;
                for (n = new Array(a), i = 0; i < a; ++i) r = e[i],
                n[r.index] = +t(r, i, e)
            }
        }
    ...
    var Pi = function(t) {
        ...
        function s(i) {
            for (var r = 0,
            o = t.length; r < u; ++r) for (var f, c, s, h, l, d, _, p = 0; p < o; ++p) c = (f = t[p]).source,
        ...
        function h() {
            if (i) {
                ...
                s = t.length,
                h = Zn(i, o);
                for (f = 0, r = new Array(u); f < s; ++f)(c = t[f]).index = f,
                ...
                for (f = 0, a = new Array(s); f < s; ++f) c = t[f],
        ...
        function l() {
            if (i) for (var n = 0,
            r = t.length; n < r; ++n) e[n] = +f(t[n], n, t)
        }
        function d() {
            if (i) for (var e = 0,
            r = t.length; e < r; ++e) n[e] = +c(t[e], e, t)
        }
        return null == t && (t = []),
    ...
    qi = function(t) {
        ...
        function h(i) {
            ...
            for (var h = 0; h < i; ++h) for (n += (a - n) * r, f.each(function(t) {
                t(n)
            }), c = 0; c < s; ++c) null == (u = t[c]).fx ? u.x += u.vx *= o: (u.x = u.fx, u.vx = 0),
    ...
    Ri = function() {
        ...
        function c(i) {
            ...
            for (n = i, r = 0; r < a; ++r) e = t[r],
            o.visit(h)
        }
        function u() {
            if (t) {
                var e, n, a = t.length;
                for (i = new Array(a), e = 0; e < a; ++e) n = t[e],
                i[n.index] = +r(n, e, t)
            }
        }
        function s(t) {
        ...
        function h(t, r, c, u) {
            ...
            l = u - r,
            d = s * s + h * h;
            if (l * l / f < d) return d < o && (0 === s && (d += (s = vi()) * s), 0 === h && (d += (h = vi()) * h), d < a && (d = Math.sqrt(a * d)), e.vx += s * t.value * n / d, e.vy += h * t.value * n / d),
            !0;
            if (! (t.length || d >= o)) { (t.data !== e || t.next) && (0 === s && (d += (s = vi()) * s), 0 === h && (d += (h = vi()) * h), d < a && (d = Math.sqrt(a * d)));
                do {
    ...
    var Xi, Vi, Bi = function(t) {
        t: for (var e, n = t.length,
        i = 1,
        r = -1; i < n; ++i) switch (t[i]) {
        case ".":
            r = e = i;
            break;
        case "0":
    ...
    Vi = function(t) {
        var e, n, i = t.grouping && t.thousands ? (e = t.grouping, n = t.thousands,
        function(t, i) {
            for (var r = t.length,
            a = [], o = 0, f = e[0], c = 0; r > 0 && f > 0 && (c + f + 1 > i && (f = Math.max(1, i - c)), a.push(t.substring(r -= f, r + f)), !((c += f + 1) > i));) f = e[o = (o + 1) % e.length];
        ...
        if (t.forEach(function(t) {
            if (! ((e = t.length - 1) <= 0)) {
                ...
                if (kr(i, o)) {
                    ...
                    r.lineEnd()
                } else f.push(n = new Tr(i, t, null, !0)),
    ...
    Sr = function(t, e) {
        ...
        for (var c = 0,
        u = t.length; c < u; ++c) if (h = (s = t[c]).length) for (var s, h, l = s[h - 1], d = l[0], _ = l[1] / 2 + rr, p = dr(_), b = sr(_), y = 0; y < h; ++y, d = g, p = m, b = w, l = v) {
            var v = s[y],
            g = v[0],
            x = v[1] / 2 + rr,
            m = dr(x),
            ...
            if (Cr.add(ur(A * k * dr(T), b * w + A * sr(T))), o += N ? M + k * ar: M, N ^ d >= n ^ g >= n) {
                ...
                var S = xr(a, C);
                mr(S);
                var E = (N ^ M >= 0 ? -1 : 1) * yr(S[2]); (i > E || i === E && (C[0] || C[1])) && (f += N ^ M >= 0 ? 1 : -1)
            }
        }
        ...
        return function(r) {
            ...
            d = {
                ...
                polygonEnd: function() {
                    ...
                    o = f(o);
                    var t = Sr(a, i);
                    o.length ? (l || (r.polygonStart(), l = !0), Nr(o, Pr, t, n, r)) : t && (l || (r.polygonStart(), l = !0), r.lineStart(), n(null, null, 1, r), r.lineEnd()),
                    l && (r.polygonEnd(), l = !1),
                    o = a = null
                },
                sphere: function() {
            ...
            function x() {
                ...
                } else d > 1 && 2 & f && u.push(u.pop().concat(u.shift())),
                o.push(u.filter(Ur))
            }
            return d
        }
    ...
    function(t) {
        ...
        return {
            ...
            point: function(a, o) {
                ...
                } (n, i, a, o), t.point(r, i), t.lineEnd(), t.lineStart(), t.point(f, i), e = 0),
                t.point(n = a, i = o),
                r = f
            },
            lineEnd: function() {
    ...
    Wr.invert = function(t, e) {
        ...
        r = i * i,
        a = r * r * r,
        o = 0; o < 12 && (a = (r = (i -= n = (i * (Xr + Vr * r + a * (Br + $r * r)) - e) / (Xr + 3 * Vr * r + a * (7 * Br + 9 * $r * r))) * i) * r * r, !(fr(n) < 1e-12)); ++o);
    ...
    function na(t, e) {
        var n, i, r, a, o, f = new oa(t),
        c = +t.value && (f.value = t.value),
        u = [f];
        for (null == e && (e = ia); n = u.pop();) if (c && (n.value = +n.data.value), (r = e(n.data)) && (o = r.length)) for (n.children = new Array(o), a = o - 1; a >= 0; --a) u.push(i = n.children[a] = new oa(r[a])),
        i.parent = n,
        i.depth = n.depth + 1;
    ...
    oa.prototype = na.prototype = {
        ...
        eachAfter: function(t) {
            for (var e, n, i, r = this,
            a = [r], o = []; r = a.pop();) if (o.push(r), e = r.children) for (n = 0, i = e.length; n < i; ++n) a.push(e[n]);
            for (; r = o.pop();) t(r);
            return this
        },
        eachBefore: function(t) {
            for (var e, n, i = this,
            r = [i]; i = r.pop();) if (t(i), e = i.children) for (n = e.length - 1; n >= 0; --n) r.push(e[n]);
            return this
        },
        sum: function(t) {
        ...
        path: function(t) {
            ...
            n = function(t, e) {
                ...
                i = e.ancestors(),
                r = null;
                for (t = n.pop(), e = i.pop(); t === e;) r = t,
                t = n.pop(),
                e = i.pop();
                return r
            } (e, t), i = [e]; e !== n;) e = e.parent,
            i.push(e);
            for (var r = i.length; t !== n;) i.splice(r, 0, t),
            t = t.parent;
            return i
        },
        ancestors: function() {
            for (var t = this,
            e = [t]; t = t.parent;) e.push(t);
            return e
        },
    ...
    var fa = function(t, e, n, i, r) {
        ...
        f = -1,
        c = o.length,
        u = t.value && (i - e) / t.value; ++f < c;)(a = o[f]).y0 = n,
        a.y1 = r,
        a.x0 = e,
        a.x1 = e += a.value * u
    };
    ...
    var ua = function(t, e, n, i, r) {
        ...
        f = -1,
        c = o.length,
        u = t.value && (r - n) / t.value; ++f < c;)(a = o[f]).x0 = e,
        a.x1 = i,
        a.y0 = n,
        a.y1 = n += a.value * u
    },
    ...
    function t(e) {
        function n(t, n, i, r, a) {
            if ((o = t._squarify) && o.ratio === e) for (var o, f, c, u, s, h = -1,
            l = o.length,
            d = t.value; ++h < l;) {
                ...
                d -= f.value
            } else t._squarify = o = ha(e, t, n, i, r, a),
            o.ratio = e
        }
        return n.ratio = function(e) {
            return t((e = +e) > 1 ? e: 1)
    ...
    function va(t, e, n, i) {
        ...
        r.filter = function(n) {
            ...
            function(t, i) {
                if (t >= t) if (i < 0) for (; ++i <= 0;) for (; e(t, -1), !n(t););
    ...
    function lo(t) {
        for (var e = {},
        n = -1,
        i = t.length; ++n < i;) e[t[n].toLowerCase()] = n;
        return e
    }
    function _o(t, e, n) {
            ...
            function M(t, e) {
                return function(n) {
                    ...
                    if ("p" in a && (a.H = a.H % 12 + 12 * a.p), "V" in a) {
                        ...
                        "w" in a || (a.w = 1),
                        "Z" in a ? (r = (i = to(eo(a.y))).getUTCDay(), i = r > 4 || 0 === r ? Xa.ceil(i) : Xa(i), i = Fa.offset(i, 7 * (a.V - 1)), a.y = i.getUTCFullYear(), a.m = i.getUTCMonth(), a.d = i.getUTCDate() + (a.w + 6) % 7) : (r = (i = e(eo(a.y))).getDay(), i = r > 4 || 0 === r ? Sa.ceil(i) : Sa(i), i = Na.offset(i, 7 * (a.V - 1)), a.y = i.getFullYear(), a.m = i.getMonth(), a.d = i.getDate() + (a.w + 6) % 7)
    ...
    Date.prototype.toISOString || io("%Y-%m-%dT%H:%M:%S.%LZ"); + new Date("2000-01-01T00:00:00.000Z") || ro("%Y-%m-%dT%H:%M:%S.%LZ");
    var yf = function(t) {
        for (var e = t.length / 6 | 0,
        n = new Array(e), i = 0; i < e;) n[i] = "#" + t.slice(6 * i, 6 * ++i);
        return n
    },
    ...
    Cf = (Math.sin(wf / 10), Math.cos(wf / 10), Math.sqrt(3), Math.sqrt(3), Math.sqrt(12),
    function() {});
    function Sf(t, e, n) {
    ...
    Lf.prototype = {
        ...
        lineEnd: function() {
            ...
            e = this._y,
            n = t.length - 1;
            if (n > 0) for (var i, r = t[0], a = e[0], o = t[n] - r, f = e[n] - a, c = -1; ++c <= n;) i = c / n,
    ...
    function Qf(t) {
        ...
        a = new Array(i),
        o = new Array(i);
        for (r[0] = 0, a[0] = 2, o[0] = t[0] + 2 * t[1], e = 1; e < i - 1; ++e) r[e] = 1,
        a[e] = 4,
        o[e] = 4 * t[e] + 2 * t[e + 1];
        for (r[i - 1] = 2, a[i - 1] = 7, o[i - 1] = 8 * t[i - 1] + t[i], e = 1; e < i; ++e) n = r[e] / a[e - 1],
        a[e] -= n,
        o[e] -= n * o[e - 1];
    ...
    Gf.prototype = {
        ...
        lineEnd: function() {
            ...
            else for (var i = Qf(t), r = Qf(e), a = 0, o = 1; o < n; ++a, ++o) this._context.bezierCurveTo(i[0][a], r[0][a], i[1][a], r[1][a], t[o], e[o]); (this._line || 0 !== this._line && 1 === n) && this._context.closePath(),
            this._line = 1 - this._line,
            this._x = this._y = null
        },
        point: function(t, e) {
    ...
    Kf.prototype = {
        ...
        insert: function(t, e) {
            ...
            for (e.L = e.R = null, e.U = n, e.C = !0, t = e; n && n.C;) n === (i = n.U).L ? (r = i.R) && r.C ? (n.C = r.C = !1, i.C = !0, t = i) : (t === n.R && (ec(this, n), n = (t = n).U), n.C = !1, i.C = !0, nc(this, i)) : (r = i.L) && r.C ? (n.C = r.C = !1, i.C = !0, t = i) : (t === n.L && (nc(this, n), n = (t = n).U), n.C = !1, i.C = !0, ec(this, i)),
            n = t.U;
            this._.C = !1
        },
        remove: function(t) {
            ...
            a = t.L,
            o = t.R;
            if (n = a ? o ? ic(o) : a: o, r ? r.L === t ? r.L = n: r.R = n: this._ = n, a && o ? (i = n.C, n.C = t.C, n.L = a, a.U = n, n !== o ? (r = n.U, n.U = t.U, t = n.R, r.L = t, n.R = o, o.U = n) : (n.U = r, r = n, t = n.R)) : (i = t.C, t = n), t && (t.U = r), !i) if (t && t.C) t.C = !1;
            else {
                do {
                    if (t === this._) break;
                    if (t === r.L) {
    ...
    function sc(t, e) {
        ...
        r = e.right;
        return n === r && (r = i, i = n),
        r ? Math.atan2(r[1] - i[1], r[0] - i[0]) : (n === i ? (i = e[1], r = e[0]) : (i = e[0], r = e[1]), Math.atan2(i[0] - r[0], r[1] - i[1]))
    }
    function hc(t, e) {
        ...
        if (e && n) {
            ...
            if (i !== a) {
                ...
                if (! (l >= -Uc)) {
                    ...
                    t.circle = y;
                    for (var v = null,
                    g = Cc._; g;) if (y.y < g.y || y.y === g.y && y.x <= g.x) {
                        if (!g.L) {
                            v = g.P;
                            break
                        }
    ...
    function wc(t) {
        ...
        f = [t];
        mc(t);
        for (var c = a; c.circle && Math.abs(n - c.circle.x) < Ec && Math.abs(i - c.circle.cy) < Ec;) a = c.P,
        f.unshift(c),
        mc(c),
        c = a;
        f.unshift(c),
        yc(c);
        for (var u = o; u.circle && Math.abs(n - u.circle.x) < Ec && Math.abs(i - u.circle.cy) < Ec;) o = u.N,
        f.push(u),
        mc(u),
        u = o;
        f.push(u),
    ...
    function Mc(t) {
        for (var e, n, i, r, a = t[0], o = t[1], f = Nc._; f;) if ((i = kc(f, o) - a) > Ec) f = f.L;
        else {
            if (! ((r = a - Tc(f, o)) > Ec)) {
    ...
    function Lc(t, e) {
        ...
        for (Sc = [], Ac = new Array(t.length), Nc = new rc, Cc = new rc;;) if (r = dc, a && (!r || a[1] < r.y || a[1] === r.y && a[0] < r.x)) a[0] === n && a[1] === i || (Mc(a), n = a[0], i = a[1]),
        a = t.pop();
        else {
            if (!r) break;
            wc(r.arc)
        ...
        if (function() {
            for (var t, e, n, i, r = 0,
            a = Ac.length; r < a; ++r) if ((t = Ac[r]) && (i = (e = t.halfedges).length)) {
                var o = new Array(i),
                f = new Array(i);
                for (n = 0; n < i; ++n) o[n] = n,
                f[n] = sc(t, Sc[e[n]]);
            ...
            function(t, e, n, i) {
                var r, a, o, f, c, u, s, h, l, d, _, p, b = Ac.length,
                y = !0;
                for (r = 0; r < b; ++r) if (a = Ac[r]) {
                    for (o = a.site, f = (c = a.halfedges).length; f--;) Sc[c[f]] || c.splice(f, 1);
                    for (f = 0, u = c.length; f < u;) _ = (d = lc(a, Sc[c[f]]))[0],
                    p = d[1],
                    h = (s = hc(a, Sc[c[++f % u]]))[0],
                    l = s[1],
                    (Math.abs(_ - h) > Ec || Math.abs(p - l) > Ec) && (c.splice(f, 0, Sc.push(oc(o, d, Math.abs(_ - t) < Ec && i - p > Ec ? [t, Math.abs(h - t) < Ec ? l: i] : Math.abs(p - i) < Ec && n - _ > Ec ? [Math.abs(l - i) < Ec ? h: n, i] : Math.abs(_ - n) < Ec && p - e > Ec ? [n, Math.abs(h - n) < Ec ? l: e] : Math.abs(p - e) < Ec && _ - t > Ec ? [Math.abs(l - e) < Ec ? h: t, e] : null)) - 1), ++u);
                    u && (y = !1)
                }
                if (y) {
                    var v, g, x, m = 1 / 0;
    ...
    Lc.prototype = {
        ...
        triangles: function() {
            ...
            return this.cells.forEach(function(n, i) {
                if (a = (r = n.halfedges).length) for (var r, a, o, f, c, u, s = n.site,
                h = -1,
                l = e[r[a - 1]], d = l.left === s ? l.right: l.left; ++h < a;) o = d,
                d = (l = e[r[h]]).left === s ? l.right: l.left,
                o && d && i < o.index && i < d.index && (c = o, u = d, ((f = s)[0] - u[0]) * (c[1] - f[1]) - (f[0] - c[0]) * (u[1] - f[1]) < 0) && t.push([s.data, o.data, d.data])
            }),
            t
        },
        links: function() {
        ...
        find: function(t, e, n) {
            for (var i, r, a = this,
            o = a._found || 0,
            f = a.cells.length; ! (r = a.cells[o]);) if (++o >= f) return null;
            var c = t - r.site[0],
            u = e - r.site[1],
            s = c * c + u * u;
            do {
    ...
    var Bc = function() {
        ...
        function w(t, e) {
            for (var n, i = 0,
            r = h.length; i < r; ++i) if ((n = h[i]).that === t) return n;
            return new M(t, e)
        }
        function M(t, e) {
            this.that = t,
        ...
        function k() {
            if (n.apply(this, arguments)) {
                ...
                o = ft(this);
                if (t.wheel) t.mouse[0][0] === o[0] && t.mouse[0][1] === o[1] || (t.mouse[1] = e.invert(t.mouse[0] = o)),
        ...
        function A() {
            if (n.apply(this, arguments)) {
                var e, i, r, a, o = w(this, arguments),
                f = V.changedTouches,
                c = f.length;
                for (Rc(), i = 0; i < c; ++i) r = f[i],
        ...
        function C() {
            var e, n, i, a, o = w(this, arguments),
            f = V.changedTouches,
            u = f.length;
            for (jc(), t && (t = clearTimeout(t)), e = 0; e < u; ++e) n = f[e],
        ...
        M.prototype = {
            start: function() {
                return 1 == ++this.active && (this.index = h.push(this) - 1, this.emit("start")),
                this
            },
            zoom: function(t, e) {
                ...
                return 0 == --this.active && (h.splice(this.index, 1), this.index = -1, this.emit("end")),
                this
            },
            emit: function(t) {
        ...
        s = function() {
            ...
            (n = [{
                ...
                value: function() {
                    var t = this,
                    e = this;
                    this.simulation = i.g(this.config.nodes).force("link", i.e(this.config.links)).force("charge", i.f().strength(this.config.chargeStrength)).force("center", i.c(this.config.width / 2, this.config.height / 2)).force("collide", i.d(this.config.collide).strength(.2).iterations(5)).alphaDecay(this.config.alphaDecay).on("tick",
                    function() {
                        return t.ticked()
                    }),
                    this.SVG = this.map.append("svg").attr("class", "svgclass").attr("width", this.config.width).attr("height", this.config.height).call(i.i().scaleExtent(this.config.scaleExtent).on("zoom",
                    function() {
                    ...
                    this.patterns = this.defs.selectAll("pattern.patternclass").data(this.config.nodes).enter().append("pattern").attr("class", "patternclass").attr("id",
                    function(t, e) {
                        return "avatar" + t.role_id
                    }).attr("patternUnits", "objectBoundingBox").attr("x", "0").attr("y", "0").attr("width", "1").attr("height", "1"),
                    this.patterns.append("image").attr("class", "circle").attr("xlink:href",
                    function(t) {
                        return t.avatar
                    }).attr("src",
                    function(t) {
                    ...
                    this.edges = this.relMap_g.selectAll("g.edge").data(this.config.links).enter().append("g").attr("class", "edge").on("mouseover",
                    function() {
                    ...
                    this.links = this.edges.append("path").attr("class", "links").attr("d",
                    function(e) {
                        return "M" + t.config.linkSrc + ",0 L" + o(e.source, e.target) + ",0"
                    }).style("marker-end", "url(#marker)").attr("stroke",
                    function(e) {
                        return e.color ? "#" + e.color: t.config.linkColor
                    }),
                    this.rect_g = this.edges.append("g").attr("class", "rect_g"),
                    this.rects = this.rect_g.append("rect").attr("x", 40).attr("y", -10).attr("width", 40).attr("height", 20).attr("fill", "white").attr("stroke",
                    function(e) {
                        return e.color ? "#" + e.color: t.config.linkColor
                    }),
                    ...
                    this.circles = this.relMap_g.selectAll("circle.circleclass").data(this.config.nodes).enter().append("circle").attr("class", "circleclass").style("cursor", "pointer").attr("fill",
                    function(t) {
                        return "url(#avatar" + t.role_id + ")"
                    }).attr("stroke", "#ccf1fc").attr("stroke-width", this.config.strokeWidth).attr("r", this.config.r).on("mouseover",
                    function(t) {
            ...
            },
            {
                ...
                value: function() {
                    var t = this;
                    this.edges.attr("transform",
                    function(t) {
                        return e = t.source,
                        n = t.target,
                        i = o(t.source, t.target),
                        n.x > e.x ? r = n.y > e.y ? Math.asin((n.y - e.y) / i) : -(r = Math.asin((e.y - n.y) / i)) : n.y > e.y ? (r = Math.asin((n.y - e.y) / i), r = Math.PI - r) : (r = Math.asin((e.y - n.y) / i), r -= Math.PI),
                        r *= 180 / Math.PI,
